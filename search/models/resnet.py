...
cfg = {
    'resnet20': ('basic', [3, 3, 3]),
    'resnet32': ('basic', [5, 5, 5]),
    'resnet44': ('basic', [7, 7, 7]),
    'resnet56': ('basic', [9, 9, 9]),
    'resnet110': ('basic', [18, 18, 18]),
}
...
def resnet(arch: str, dataset: str):
