...
namespace minicomp
{
	...
	@param[in] coeff_in The coefficients of root polynomial based on basis polynomials (power, Cheb, scaled Cheb)
	@param[in] cheby_coeff chebyshev coefficients
	...
	*/
	void poly_decompose_integrate(int deg, int input_type, RR input_scale, vector<double> &coeff_in, vector<double> &cheby_coeff, Tree& tree, evaltype eval_type, int output_type, RR output_scale);
